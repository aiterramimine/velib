...
namespace ConsoleApp1.VelibPlannerServiceReference {
    ...
    public interface IVelibPlannerService {
        ...
        velibPlanner.Route ComputeRoute(velibPlanner.Location current, velibPlanner.Location destination, velibPlanner.Mock m);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IVelibPlannerService/ComputeRoute", ReplyAction="http://tempuri.org/IVelibPlannerService/ComputeRouteResponse")]
        System.Threading.Tasks.Task<velibPlanner.Route> ComputeRouteAsync(velibPlanner.Location current, velibPlanner.Location destination, velibPlanner.Mock m);
    }
    ...
    public partial class VelibPlannerServiceClient : System.ServiceModel.ClientBase<ConsoleApp1.VelibPlannerServiceReference.IVelibPlannerService>, ConsoleApp1.VelibPlannerServiceReference.IVelibPlannerService {
        ...
        public velibPlanner.Route ComputeRoute(velibPlanner.Location current, velibPlanner.Location destination, velibPlanner.Mock m) {
            return base.Channel.ComputeRoute(current, destination, m);
        }
        
        public System.Threading.Tasks.Task<velibPlanner.Route> ComputeRouteAsync(velibPlanner.Location current, velibPlanner.Location destination, velibPlanner.Mock m) {
            return base.Channel.ComputeRouteAsync(current, destination, m);
        }
    }
}
